...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', type=str, default='../rtdetrv2_pytorch/configs/rtdetrv2/dronesite.yml'),
    parser.add_argument('-w', '--weight', type=str, default='ckpt/rtdetr2_e36_best.pth'),
