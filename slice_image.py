...
def main():
    ...
    parser.add_argument(
        '--image_dir', type=str, default='/mnt/sda1/datasets/drone_site/dataset/images/train', help="The image folder path.")
    parser.add_argument(
        '--json_path', type=str, default='/mnt/sda1/datasets/drone_site/dataset/annotations/train.json', help="Dataset json path.")
    parser.add_argument(
        '--output_dir', type=str, default='/mnt/sda1/datasets/drone_site/dataset', help="Output dir.")
    parser.add_argument(
        '--slice_size', type=int, default=640, help="slice_size")
    parser.add_argument(
